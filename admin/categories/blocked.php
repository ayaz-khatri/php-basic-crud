...
<head>
    <title>Blocked Categories</title>
...
<body>
    ...
    <div class="container my-4">
        <div class="row px-2">
            <div class="col-6">
                <h2 class="text-danger fw-bold">Blocked Categories</h2>
            </div>
            <div class="col-6 text-end">
                <div class="btn-group" role="group" aria-label="Basic outlined example">
                    <a href="create.php" type="button" class="btn btn-sm btn-outline-secondary">Create Category</a>
                    <a href="categories.php" type="button" class="btn btn-sm btn-outline-danger">Categories</a>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
        <div class="col">
            <h5 class="mb-3">All Blocked Categories</h5>
            <div id="crudTable">
            <div class="table-responsive">
                ...
                <?php 
                $paramList = [];
                $sql = "SELECT * FROM categories WHERE category_status = 0 ORDER BY category_id DESC";
                ...
                foreach($result as $res) { 
                    ...
                    <?php $img = empty($res['category_image']) ? "../../images/placeholder.png" : "../uploads/categories/" . $res['category_image']?>
                    ...
                    <td>
                        <a href="#" class="unblock btn btn-success btn-sm" data-id=<?php echo $res['category_id'] ?>>
                        <i class="fa-solid fa-lock-open" data-bs-toggle="tooltip" data-bs-placement="top" title="Unblock"></i>
                        </a>
                        |
                        <a href="#" class="delete btn btn-danger btn-sm" data-id=<?php echo $res['category_id'] ?>>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="#">
                <p id="modalMessage">Are you sure you want to permanantly delete this Category?</p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <form id="deleteSelectedForm" method="POST" action="delete-selected.php">
                    <p id="modalMessage">Are you sure you want to permanantly delete selected Category[s]?</p>
    ...
    <div class="modal fade" id="deleteAllModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
            <form action="#">
                <p id="modalMessage">Are you sure you want to permanantly delete all Categories?</p>
    ...
    <div class="modal fade" id="unblockModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
            <form action="#">
                <p id="modalMessage">Are you sure you want to unblock this Category?</p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <form id="unblockSelectedForm" method="POST" action="unblock-selected.php">
                    <p id="modalMessage">Are you sure you want to unblock selected Category[s]?</p>
                    <!-- Hidden input fields to store selected IDs -->
    ...
    <div class="modal fade" id="unblockAllModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
            <form action="#">
                <p id="modalMessage">Are you sure you want to unblock all Categories?</p>
