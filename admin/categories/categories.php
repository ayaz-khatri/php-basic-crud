...
<body>
    ...
    <div class="container my-4">
        <div class="row px-2">
            <div class="col-6">
                <h2 class="text-danger fw-bold">Categories</h2>
            </div>
    ...
    <div class="container">
        ...
        <div class="col">
            ...
            <div class="table-responsive">
                ...
                <?php 
                $paramList = [];
                $sql = "SELECT * FROM categories WHERE category_status = 1 ORDER BY category_id DESC";
                ...
                foreach($result as $res) { 
                    ...
                    <td>
                        <a href="view.php?id=<?php echo $res['category_id'] ?>" class="btn btn-success btn-sm" id="btnView">
                        <i class="fa fa-eye" data-bs-toggle="tooltip" data-bs-placement="top" title="View"></i>
                        </a>
                        |
                        <a href="edit.php?id=<?php echo $res['category_id'] ?>" class="btn btn-primary btn-sm" id="btnEdit">
                        <i class="fa fa-edit" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"></i>
                        </a>
                        |
                        <a href="#" class="block btn btn-warning btn-sm" data-id=<?php echo $res['category_id'] ?>>
    ...
    <div class="modal fade" id="blockModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
            <form action="#">
                <p id="modalMessage">Are you sure you want to block this category?</p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <form id="blockSelectedForm" method="POST" action="block-selected.php">
                    <p id="modalMessage">Are you sure you want to block selected category[s]?</p>
                    <!-- Hidden input fields to store selected IDs -->
    ...
    <div class="modal fade" id="blockAllModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
            <form action="#">
                <p id="modalMessage">Are you sure you want to block all categories?</p>
