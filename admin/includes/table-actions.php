<td>
    ...
    <?php 
        ...
        { ?>
            ...
            <a href="view.php?id=<?php echo $row['id'] ?>" class="btn btn-success btn-sm" id="btnView">
            <i class="fa fa-eye" data-bs-toggle="tooltip" data-bs-placement="top" title="View"></i>
            </a>
            |
            <a href="edit.php?id=<?php echo $row['id'] ?>" class="btn btn-primary btn-sm" id="btnEdit">
            <i class="fa fa-edit" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"></i>
            </a>
            |
            <a href="#" class="block btn btn-warning btn-sm" data-id=<?php echo $row['id'] ?>>
            <i class="fa fa-trash-alt" data-bs-toggle="tooltip" data-bs-placement="top" title="Block"></i>
            </a>
            |
            <a href="#" class="delete btn btn-danger btn-sm" data-id=<?php echo $row['id'] ?>>
        ...
        { ?>
            ...
            <a href="#" class="unblock btn btn-success btn-sm" data-id=<?php echo $row['id'] ?>>
